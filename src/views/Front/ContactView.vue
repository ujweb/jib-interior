    ...
    <div class="container">
      <div class="row">
        ...
        <div class="content col-xl-8 col-md-9">
          <form method="post" action="https://docs.google.com/forms/u/0/d/e/1FAIpQLScdPpK935_q3UMWAe6SbZfV0wHLw0SdkL7nBo33cVOEzv_aVw/formResponse" target="response_frame">
            <div class="mb-20">
            ...
            <div class="mb-20">
              ...
              <input
                ...
                name="entry.2082609530" required
              >
            </div>
            <div class="mb-20">
              ...
              <textarea
                ...
                v-model="form.ask"
                placeholder="請輸入詢問內容"
                name="entry.2043559219" required
              ></textarea>
            </div>
            <div class="form-check mb-40">
              ...
              <label class="form-check-label" for="readCheck">
                ...
                <span class="fs-4 text-gray-400">
                  Jib 室內設計公司（以下統稱我們）為本服務之目的向您蒐集、處理、利用您的資料包括您的
                  【姓名、電話、Email 或其他得以直接或間接識別您個人之資料】，通過遞交此表格，
                  您確認同意我們按照隱私權聲明存儲及處理您的個人資料。<br/>
                  您可依個人資料保護法規定，就您的個人資料向我們行使下列權利：
                  (1) 查詢或請求閱覽 (2) 請求製給複製本 (3) 請求補充或更正 (4) 請求停止蒐集、處理及利用 (5) 請求刪除。
                </span>
              </label>
            </div>
            <button
          ...
          <iframe name="response_frame" class="d-none" title="回覆不跳頁用"></iframe>
        </div>
      </div>
    </div>
  </article>
