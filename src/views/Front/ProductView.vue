        ...
        <div class="row">
          <div class="col-md-5 col-sticky">
            <div class="d-md-none">
              <ul class="breadcrumb">
                <li>
                  <RouterLink to="/products?category=all">家具選購</RouterLink>
                </li>
                <li>
                  <RouterLink
            ...
            <div class="swiper-group">
              ...
              >
                ...
                <SwiperSlide
                  v-for="(imgUrl, index) in product.imagesUrl"
                  :key="index"
                >
                  <img
                    :src="imgUrl"
              ...
              <swiper
                class="swiper-thumb d-sm-block d-none mt-20"
                :modules="[Thumbs]"
          ...
          <div class="col-md-7">
            ...
            <div class="content">
              ...
              <p>
                使用 Jib
                為您的家具提供更優惠的價格，我們也不會將任何多於費用轉嫁給您。
                如果您在其他家具網站上找到更優惠的價格，請告訴我們，我們會為您比價，確認後若你立即購買，即享
                9 折優惠。
              </p>
              <h3 class="mt-50 mb-10">配送規則</h3>
              <p class="my-10">
                由於 Jib 超過 10,000 元的訂單都有資格免費送貨。 1,000
                元的固定運費適用於 10,000 元以下的訂單。 對於較大的家具，Jib
                與專門從事家具運輸的運送方合作，以確保產品安全無虞地到達。
              </p>
              <h3 class="mt-50 mb-10">退貨規則</h3>
              <p class="my-10">
                我們知道購買家具的過程可能會帶來壓力。這就是為什麼 Jib
                團隊在這里為您處理所有退貨並讓您的體驗盡可能輕鬆。
                您可以在交貨後 30
                天內退回大多數物品以獲得退款。但需要您支付退貨運費，此位該家具必須保持完整產品及包裝。
              </p>
            </div>
          </div>
          <div class="recommend col-12 pt-md-50" v-if="recommends.length > 0">
            <hr class="my-50" />
            <h2 class="mb-20">推薦商品</h2>
            <swiper
